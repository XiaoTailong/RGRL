...
from QENV_small_range_nodone_rfixed_multidiscrete_01 import QIsingEnv
...
def parse_args():
    ...
    parser.add_argument("--action-step", type=float, default=0.01,
                        help="the learning rate of the optimizer")
    parser.add_argument("--small-range", type=float, default=0.2,
                        help="the small range of reset")
...
if __name__ == "__main__":
    ...
    envs = gym.vector.SyncVectorEnv(
        [lambda: QIsingEnv(target_param=target_param, agent_param=agent_param,
                    maximum_counter=args.num_steps,
                    n_views=args.n_views, small_range=args.small_range,
                    action_step=args.action_step)] * args.num_envs
    )
