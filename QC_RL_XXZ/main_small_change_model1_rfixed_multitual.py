...
from XXZ_ENV_small_change_model1_rfixed_label_mu_inf import XXZEnv
...
if __name__ == "__main__":
    ...
    # 不同的seed，不同的目标参数
    run_name = f"{args.exp_name}_{args.seed}_{args.target_case}_ns{args.num_steps}_nv{args.n_views}_action_complete_case1_10"
