...
from XXZ_ENV_small_change_model1_rfixed_DQN import XXZEnv
...
def parse_args():
    ...
    parser.add_argument("--maximum-counter", type=int, default=100,
...
if args.target_case == 1:
    ...
    initial_agent_id = np.array([ids[8], ids[19]], dtype=np.int32)
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        if global_steps % args.maximum_counter == 0:
            print("steps {}, reward={}, fidelity={}, param={}".format(global_steps,
            reward.item(), info["quantum_fidelity"], info["param_distance"]), flush=True)
